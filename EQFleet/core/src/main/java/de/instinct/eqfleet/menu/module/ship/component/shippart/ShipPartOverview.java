...
public class ShipPartOverview extends Component {
	...
	private void createLevelArea() {
		...
		levelArea = new ShipPartLevelArea(shipComponentLevel.getLevel(), getPartTypeColor(), shipComponentLevel.getProgress(), nextLevel == null ? currentLevel.getRequirementValue() : nextLevel.getRequirementValue() - currentLevel.getRequirementValue());
