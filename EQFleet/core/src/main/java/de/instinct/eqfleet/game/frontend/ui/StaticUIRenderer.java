...
public class StaticUIRenderer {
	...
	private void loadBounds() {
		GameModel.uiBounds = UIBounds.builder()
				...
				.ownResBar(new Rectangle(47, 33, 330, 27))
				.ownResBarLabel(new Rectangle(20, 23, 27, 27))
				.teammate1ResBar(new Rectangle(75, (23 + 27 + 3), 135, 20))
				.teammate1ResBarLabel(new Rectangle(50, (23 + 27 + 3), 25, 20))
				.teammate2ResBar(new Rectangle((75 + 155 + 10), (23 + 27 + 3), 135, 20))
				.teammate2ResBarLabel(new Rectangle((50 + 155 + 10), (23 + 27 + 3), 25, 20))
