...
public class EngineUtility {
	...
	public static int totalPlayerCount(GameType gameType) {
		int teamSize = gameType.factionMode.teamPlayerCount;
		return gameType.versusMode == VersusMode.AI ? teamSize : teamSize * 2;
	}
