package de.instinct.engine.core.util;
...
public class VectorUtil {
	...
	public static Vector2 getRotatedDirection(Vector2 direction, float rotationDegrees) {
		return direction.rotateDeg(rotationDegrees);
	}
