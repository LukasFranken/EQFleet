package de.instinct.engine.fleet.stats;
...
import de.instinct.engine.fleet.stats.model.unit.TurretStatistic;
import de.instinct.engine.fleet.stats.model.unit.component.types.CoreStatistic;
import de.instinct.engine.fleet.stats.model.unit.component.types.EngineStatistic;
import de.instinct.engine.fleet.stats.model.unit.component.types.HullStatistic;
...
public class StatCollector {
	...
	public static void initialize(String gameUUID, List<Player> players) {
		...
		for (Player player : players) {
			StatCollector.initializePlayer(gameUUID, (FleetPlayer)player);
		}
	}
	...
	public static void initializePlayer(String gameUUID, FleetPlayer player) {
